...
public class RocketMain {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		System.out.println(String.format("Total cost for R1 fleet %d million", budgetForR1));
		System.out.println("*****************************************************************************************");
		...
		System.out.println(String.format("Total cost for R2 fleet %d million", budgetForR2));
		System.out.println("*****************************************************************************************");
	}
